...
num_points = 72
max_lanes = 18
# sample_y = range(960, 150, -10)
end = int(0.2 * 966)
start = int(0.94 * 966)
step = (start-end) // (num_points - 1)
sample_y = range(start, end-1, -step)
# np.linspace(0.2 * H, 0.95 * H, 85, dtype=int).tolist()
...
dataset_path = '/mnt/mmlab2024nas/huycq/chuong/temp/YOLOP/data/woodscape_m/images'
dataset_type = 'WoodScape'
test_json_file = '/mnt/mmlab2024nas/huycq/chuong/temp/YOLOP/data/woodscape_m/images/val.json'
